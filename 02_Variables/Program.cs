...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // karakter türünce değişken örn şifreleme algoritması sezar şifreleme :
            // ABCDEFGH alfabedeki her karakteri o karakterden 3 sonraki karakterle değiştirir
            //DEF...
            // "TOPLANTI SAAT 20:00'DE" şifreli göndermek istersek bu mesajı şifreli olarak göndermek için her karaktere erişim sağlayacağız. Stringi bütün olarak değil karakter olarak ele almamız gerekir. Burada kullanırız.
            ...
            //passengerName = Console.ReadLine(); //girdiğimiz değeri passenger namein üzerine yazar
            ...
            //Console.WriteLine("----------------------------------");
            //Console.WriteLine("Yolcu: " + passengerIdentityNumber + " " + passengerName + " " + passengerSurname + "" +
            ...
            //C# dili konsol ekranı üzerinde girilen değerleri başlangıçta string olarak değerlendirir. Başka veri tipi olarak kullanmak istersek dönüşüm yapmalıyız.
            //ABC12D bu şekildeki kullanımlarda string olarak kalabilir.
            ...
            //shoesCount = int.Parse(Console.ReadLine()); //Parse methoduyla dönüşüm yapabiliriz
